...
if choose == 'Vorlesung 2':
    ...
    if not S or not V:
        ...
        if valid_subsets_1:
            ...
            st.success(f"Резултат 1: Съществуват подмножества s = :blue[{V}], за които :blue[∀v ∈ V: Da(s, v)] е **:green[вярно]**. С други думи, всяко :blue[v] се съдържа в съществуващи елементи отподмножеството :blue[s] и правилото от функцията е изпълнено.")
        else:
