...
if choose == 'Vorlesung 2':
    ...
    if not S or not V:
        ...
        if valid_subsets_1:
            ...
            st.success(f"**Резултат 1**: **:green[Правилото от функцията е изпълнено!]**. Съществуват подмножества s = :blue[{V}], за които :blue[∀v ∈ V: Da(s, v)] е **:green[вярно]**. С други думи, всяко :blue[v] се съдържа в съществуващи елементи от подмножеството :blue[s] и правилото от функцията е изпълнено.")
        else:
        ...
        if largest_valid_subsets_2:
            st.success(f"**Резултат 2**: **:green[Правилото от функцията е изпълнено!]**. Съществуват подмножества s = :blue[{largest_valid_subsets_2}], за които :blue[∀v ∈ V: Da2(s, v)] е **:green[вярно]**. С други думи, всяко :blue[v] e по-голямо или равно на съществуващи елементи от подмножеството :blue[s] и правилото от функцията е изпълнено.")
        else:
